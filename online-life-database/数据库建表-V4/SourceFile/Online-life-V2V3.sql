/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2025-05-22 20:37:07                          */
/*==============================================================*/
...
alter table GroupDetails comment '一个团办事宜可以由多个用户参与
一个用户可以参与多个团办事宜';
...
alter table GroupDetails add constraint FK_团办事宜与用户 foreign key (UserID)
      references Client (UserID) on delete restrict on update restrict;

alter table GroupDetails add constraint FK_团办事宜与用户2 foreign key (GroupTaskID)
